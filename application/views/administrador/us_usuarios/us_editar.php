...
<html lang="en" class="no-js">
	<head>
		<title>Mia Office | Editar usuario</title>
		<meta charset="utf-8" />
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<div class="page-header">
						<h1>Editar usuario: <?= $usuario->us_usuario; ?></h1>
					</div>
				</div>
			</div>
			<div class="container">
				<div class="row">
					<form method="POST" id="formulario_usuario" action="<?= base_url(); ?>us_usuarios/ejecuta_editar_usuario" class="form-horizontal" autocomplete="off">
					
					<input type="hidden" name="id" value="<?= isset($usuario)?$usuario->us_id_usuario:set_value('id'); ?>">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<input type="text" placeholder="Nombre" name="us_nombre" id="us_nombre" class="form-control" 
									value="<?= isset($usuario)?$usuario->us_nombre:set_value('us_nombre'); ?>">
								...
								<div class="col-xs-12 col-sm-3">
									...
									id="us_apellido_paterno" class="form-control" 
									value="<?= isset($usuario)?$usuario->us_apellido_paterno:set_value('us_apellido_paterno'); ?>">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<input type="text" placeholder="Apellido materno" name="us_apellido_materno" id="us_apellido_materno" class="form-control"
									value="<?= isset($usuario)?$usuario->us_apellido_materno:set_value('us_apellido_materno'); ?>">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<input type="email" placeholder="Correo" name="us_correo" id="us_correo" class="form-control" value="<?= isset($usuario)?$usuario->us_correo:set_value('us_correo'); ?>">
						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<input type="text" placeholder="Usuario" name="us_usuario" id="us_usuario" class="form-control tooltips" data-placement="top" data-rel="tooltip" data-original-title="El nombre de usuario solo debe contener letras y números, con longitud de 5 a 15 caracteres." value="<?= isset($usuario)?$usuario->us_usuario:set_value('us_usuario'); ?>">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<select class="form-control" id="us_id_nivel_usuario" name="us_id_nivel_usuario">
								        ...
								        if($usuario->us_id_nivel_usuario == $row->nu_id_nivel_usuario) echo 'selected="selected"'	?>  >
		...
		function validaciongeneral(){
		  ...
		  if (
		    ...
		    if(band==0){
		        $.ajax({
		            type: 'POST',
		            url:  '<?= base_url(); ?>us_usuarios/validar_usuario_editar_ajax',
		            ...
		            success: function(resp) { 
		                ...
		                if( resp.error_us_correo==0 && resp.error_us_usuario==0){
		                    $.confirm({
								title: '¿Deseas editar el usuario: '+us_usuario+'?',
          						theme: 'modern',
