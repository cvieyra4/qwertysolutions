						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<input type="text" placeholder="Nombre" name="cl_nombre" id="cl_nombre" class="form-control" value="<?= set_value('cl_nombre'); ?>">
								...
								<div class="col-xs-12 col-sm-3">
									...
									<input type="email" placeholder="Correo" name="cl_correo" id="cl_correo" class="form-control" value="<?= set_value('cl_correo'); ?>">
		...
		function validaciongeneral(){
		  ...
		  if (
		    ...
		    $(".error_cl_usuario").text("");
		  	$(".error_cl_contrasenia").text("");
		  	$(".error_cl_fcontrasenia").text("");
			...
			var expreg_pass = /^[A-Z]{1}[a-z0-9]{5,8}[&$#_?¡()=]{1}$/;
		  	if(expreg_pass.test(cl_contrasenia.trim())){
		        ...
		        $(".error_cl_contrasenia").html('La contraseña debe contener la primera letra mayuscula, el ultimo caracter debe ser caracter y deben ser 7 a 10 digitos.');
		  		band = 2;
		    }
		    ...
		    if(band==0){
		        $.ajax({
		            type: 'POST',
		            url:  '<?php echo base_url(); ?>cl_clientes/validar_cliente_ajax',
		    ...
		    if (
		        ...
		        $(".error_cl_contrasenia").text(req);
		        $(".error_cl_fcontrasenia").text(req);
		    ...
		    if(cl_contrasenia.trim() == "")$(".error_cl_contrasenia").text(req);
		        else $(".error_cl_contrasenia").text("");

		    if(cl_fcontrasenia.trim() == "")$(".error_cl_fcontrasenia").text(req);
		        else $(".error_cl_fcontrasenia").text("");
